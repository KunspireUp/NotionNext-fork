...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Kunspire', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '保持学习、永无止尽', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://kunspire.top', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'sengxi.yang@outlook.com', // 邮箱地址 例如mail@tangly1024.com
  ...
  POSTS_SHARE_SERVICES:
    ...
    'link,wechat,qq,weibo,email,facebook,twitter,telegram,messenger,line,reddit,whatsapp',
    // 分享的服務，按顺序显示,逗号隔开
